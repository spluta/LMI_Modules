NN_Synths_Mod : Module_Mod {
	...
	init {
		...
		trainingButtons.add(Button()
			.states_([["randomPoints", Color.green, Color.black],["randomPoints", Color.green, Color.black]])
			.action_{
				if(nn_synths[currentSynth]!=nil){nn_synths[currentSynth].newRandomTraining};
		});
		...
		trainingButtons.add(Button()
			.states_([["reloadSynth", Color.green, Color.black],["reloadSynth", Color.green, Color.black]])
			.action_{
